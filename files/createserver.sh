...
for name in ${instances[@]}; do
    ...
    instance_id=$(aws ec2 run-instances --image-id ami-09c813fb71547fc4f --instance-type $instance_type --security-group-ids sg-08d86f253ac9d8ab9 --subnet-id subnet-016cb64508afa02b9 --query 'Instances[0].InstanceId' --output text)
